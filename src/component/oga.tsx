...
  // Removed: const formActionUrl = "...";
  // Removed: const handleSubmit = ...;
...
      {/* Right side form */}
      <motion.div
        className="bg-white/10 backdrop-blur-md rounded-xl p-6 w-[95vw] max-w-md lg:w-[500px] shadow-2xl border border-white/20 -ml-4 mx-auto lg:mx-0" // <-- ADJUSTMENT HERE
...
        </h2>
            
        {/* The form now relies on the default HTML submission and page refresh */}
